                        ...
                        <form action="/admin/proveedores" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        <label>Correo</label>
                                        <input type="text" name="correo" class="form-control" placeholder="Proveedor@ejemplo.com">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telefono" class="form-control" placeholder="Campo obligatorio" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4"> 
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="telefono_fax" class="form-control">
                                    </div>
                                </div>
