                ...
                <form id="form-create" action="/admin/usuarios" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <a class="button action_upload_create">                   
                            <input type="file" id="imagen_create" accept="image/*">
                        </a>                       
                        <small class="form-text text-muted"><strong>Información:</strong> si no escoge una imagen, se le asignará una prestablecida.</small>
                    </div>
