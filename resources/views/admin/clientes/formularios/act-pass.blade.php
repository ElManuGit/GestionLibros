    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{'/clientes/actpass/'.Auth::user()->id}}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn  btn-warning" onclick="$('#boton_submit_update_pass').click()">Guardar cambios</button>
            </div>
        </div>
    </div>
</div>
